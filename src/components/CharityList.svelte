<script>
    ...
    function calculateFundend(pledged, target) {
                ...
                <div class="xs-popular-item xs-box-shadow">
                    ...
                    <ul class="xs-list-with-content">
                        ...
                        <li><span class="number-percentage-count number-percentage" data-value="90"
                            data-animation-duration="3500">{calculateFundend(charity.pledged, charity.target)}</span>% <span>Funded</span></li>
