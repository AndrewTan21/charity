        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="xs-donation-form-wraper">
              ...
              <form action="#" on:submit|preventDefault="{handleForm}" method="post" id="xs-donation-form" class=
              "xs-donation-form" name="xs-donation-form">
                <div class="xs-input-group">
                  <label for="xs-donate-name">Donation Amount <span class=
                  "color-light-red">**</span></label> <input type="text" name="name" id="xs-donate-name" class="form-control" bind:value="{amount}" required="true" placeholder="Your donation in Rupiah">
